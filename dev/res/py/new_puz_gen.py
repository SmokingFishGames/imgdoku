...
class SudokuPuzzle:
    def __init__(self, rows_in_block = 3, cols_in_block = 3):
   ...
   #
    ...
    def generate_web_string(self):
        ...
        for i in range(0, len(self.entries)):
            ...
            puzzle_str += '_' if len(self.entries.possibleValues) > 1 else str(self.master_board[i])
